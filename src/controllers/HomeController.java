...
public class HomeController  implements Initializable{
    ...
    @FXML
    void appartements(MouseEvent event) {
    	try {
			fxml = FXMLLoader.load(getClass().getResource("/interfaces/Appartement.fxml"));
    ...
    @FXML
    void contrats(MouseEvent event) {
    	try {
    ...
    @FXML
    void immeubles(MouseEvent event) {
    	try {
    ...
    @FXML
    void locataires(MouseEvent event) {
    	try {
    ...
    @FXML
    void paiements(MouseEvent event) {
    	try {
			fxml = FXMLLoader.load(getClass().getResource("/interfaces/Paiement.fxml"));
			root.getChildren().removeAll();
			root.getChildren().setAll(fxml);
		} catch (IOException e) {
			e.printStackTrace();
